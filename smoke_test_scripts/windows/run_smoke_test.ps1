...
try {
    ...
    New-Item -ItemType Directory -Force -Path $testing_dr_cli_config_dir | Out-Null
    ...
    if (-not $url_accessible) {
        ...
        # Note: Full template testing requires interactive automation tool for Windows
        # This would need something like Pester with UI automation or a custom solution
        Write-End
    }
