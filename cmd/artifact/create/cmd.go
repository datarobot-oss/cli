...
func Cmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Create an artifact in your DataRobot deployment infrastructure.
...
Container lifecycles:
  ...
  2. Build from source: set imageBuildConfig.dockerfile.source = "provided"
     ...
     'dr artifact code sync' fills in imageBuildConfig.codeRef after upload.
...
Example:
  ...
  dr artifact create --spec-file spec.yaml --output-format json`,
		Args:    cobra.NoArgs,
