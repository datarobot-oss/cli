...
func writeDotenvFile(dotenvFile string) ([]variable, string, string, error) {
	templateLines, templateFile := readTemplate(dotenvFile)
	...
	_, err = f.WriteString("# Autogenerated by dr dotenv from " + templateFile + " file\n\n")
	if err != nil {
		return nil, "", "", err
	}
	...
	return variables, contents, templateFile, nil
}
